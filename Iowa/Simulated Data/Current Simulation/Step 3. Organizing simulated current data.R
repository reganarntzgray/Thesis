...
deseasonalized <- read.table("weather_current_deseasonalized_Iowa")
...
colnames(year1) <- colnames(deseasonalized)
...
weather <- readRDS("C:/Users/Regan/Google Drive/Thesis Presentations and Proposal/Thesis/Data needed to complete empirical work/Daily weather data/Iowa/daily_weather_iowa")

N <- 99
T <- 100

county_full <- weather[1:(365*N),2]
