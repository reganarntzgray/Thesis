...
county_full <- weather2[1:(365*N),3]
...
weather3 <- readRDS("C:/Users/Regan/Google Drive/Thesis Presentations and Proposal/Thesis/Data needed to complete empirical work/Data sets for model testing/Ontario/Data_d_iii_ont")

counties <- unique(weather3$county)

Plant_silk<-Plant_silk[Plant_silk$county %in% counties,]
