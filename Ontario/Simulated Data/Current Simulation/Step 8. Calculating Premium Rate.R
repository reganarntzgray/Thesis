...
Yield <- read.table("Yield_current_sim_Ontario")
...
Premiums_Ontario_current <- data.frame(county,premium_dyn,premium_stat,ratio)

write.table(Premiums_Ontario_current,"Premiums_Ontario_current")

install.packages("stargazer")
library(stargazer)

stargazer(Premiums_Ontario_current, nobs=F,summary.logical = F, flip=TRUE)
