...
distance <- function(w1,w2) #setting distance metric equal to Euclidean distance and accounting for correlation
...
#need to do for all 100 years that we want to simulate
