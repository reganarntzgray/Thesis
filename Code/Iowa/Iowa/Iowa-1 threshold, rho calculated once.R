...
pcp_pol_sp <- (pcp_pol_i-k_opt)*(pcp_pol_i>k_opt)
...
mod <- lm(Ynew~0+Xnew)
Beta_dynamic <- summary(mod)$coeff[,1]

install.packages("stargazer")
library(stargazer)
stargazer(mod, title="Dynamic Threshold Model Results - Iowa", align=TRUE)
 #add in this table to ch. 5/6#
...
write.table(thresholds,"C:/Users/Regan/Google Drive/Thesis Presentations and Proposal/Thesis/Data needed to complete empirical work/simulated weather/Iowa/thresholds_dynamic")
