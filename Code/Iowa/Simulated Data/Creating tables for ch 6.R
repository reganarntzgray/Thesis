...
Y_current <- read.table("Yield_current_sim_Iowa")

Y_future_nochange <- read.table("Exp_Yield_nochange")

Y_future_change <- read.table("Exp_Yield_change")

Y_future <- read.table("Yield_future_sim_Iowa")
...
premiums_cur <- read.table("Premiums_Iowa_current")
premiums_fut <- read.table("Premiums_Iowa_future")
...
write.table(Current_Yield_Summary,"Current_Yield_Summary_Iowa")
...
write.table(Future_Yield_Summary,"Future_Yield_Summary_Iowa")
...
write.table(Expected_Yield_Summary,"Expected_Yield_Summary_Iowa")
