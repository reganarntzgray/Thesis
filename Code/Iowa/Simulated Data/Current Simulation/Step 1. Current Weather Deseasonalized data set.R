...
write.table(mean_day,"Data needed to complete empirical work/simulated weather/Iowa/current_mean_day")
...
write.table(sd_day,"Data needed to complete empirical work/simulated weather/Iowa/current_sd_day")

sd_day <- do.call(rbind, replicate(T, sd_day, simplify=FALSE))

weather_deseasonalized <- weather_demeaned/sd_day

write.table(weather_deseasonalized,"Data needed to complete empirical work/simulated weather/Iowa/weather_current_deseasonalized_Iowa")
