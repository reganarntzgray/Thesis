...
weather <- read.table("current_sim_stacked_daily_weather")
attach(weather)
...
daily_current_sim_weather_full <- data.frame(weather,vpd,gdd,hdd,gdd_ag)


write.table(daily_current_sim_weather_full,"daily_current_sim_weather_full")
